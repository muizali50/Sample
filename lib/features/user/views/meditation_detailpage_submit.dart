...
class MeditationDetailpageSubmit extends StatefulWidget {
              ...
              children: [
                ...
                BlocConsumer<AdminBloc, AdminState>(
                  listener: (context, state) {
                    if (state is MeditationVideoReactionUpdated) {
                    ...
                    } else if (state is MeditationVideoReactionUpdatedFailed) {
                      ScaffoldMessenger.of(
                        context,
                      ).showSnackBar(
                        SnackBar(
                  ...
                  builder: (context, state) {
                    if (state is UpdatingMeditationVideoReaction) {
                    ...
                    return Padding(
                      ...
                      child: AppPrimaryButton(
                        ...
                        onTap: () {
                          ...
                          adminBloc.add(
                            UpdateMeditationVideoReaction(
                              widget.meditationVideos.videoId.toString(),
                              selectedReaction,
                            ),
                          );
                        },
